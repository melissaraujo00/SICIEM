...
<table border="1" bgcolor="white" align="center">
	...
	<img src="imagenes/busqueda.ico" width="50" height="50"></h2></center>
			...
			<p>ingrese el nombre de la persona que se le asigno:</p>
			<input type="text" name="asignacion" value="<?php echo @$_POST['asignacion']?>">
	...
	$consulta_mobiliario = mysqli_query($conexion, "SELECT * FROM mobiliarioyequipo WHERE asignacion LIKE '%$asignacion%'
		OR asignacion LIKE '%$asignacion%'
		OR CONCAT(asignacion,'', asignacion) LIKE '%$asignacion'");
	$cantidad_registro = mysqli_num_rows($consulta_mobiliario);

	if ($cantidad_registro === 0) {
		echo "<tr><td><font color='red' size='4'>No hay registro con el codigo: ".$asignacion."</font></td></tr>";
	} else { ?>
	<tr >
		<td>N°</td>
