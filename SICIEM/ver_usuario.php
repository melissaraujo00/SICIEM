...
<form action="guardar_usuario.php" method="POST">
	...
	<table bgcolor="white" border="0">
		<tr>
			...
			<td> <input type="text" name="nombre_completo" value="<?php  echo $usuarios['nombre_completo']; ?>" readonly></td>
		</tr>
		<tr>
			<td>Usuario de acceso</td>
			<td> <input type="text" name="usuario" value="<?php  echo $usuarios['usuario']; ?>" readonly></td>
		</tr>
		<tr>
			<td>Escriba una contrseña:</td>
			<td> <input type="password" name="password1" value="<?php  echo $usuarios['password']; ?>" readonly></td>
		</tr>
	</table>
	</div>
</form>
